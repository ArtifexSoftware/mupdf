...
MuPDF can open many document types such as PDF, XPS, CBZ, EPUB, FictionBook2
...
.. function:: Document.openDocument(fileName [, magic])

	Open the named document.

	:param string fileName: File name to open.
	:param string magic: MIME type or file extension.
	:returns: Document
...
.. method:: Document.prototype.layout(pageWidth, pageHeight, fontSize)
	...
	Layout a reflowable document (EPUB, FictionBook2, HMTL or XHTML) to fit
...
.. method:: Document.prototype.loadPage(number)
	...
	Returns a `Page` (or `PDFPage`) object for the given page number.
...
.. method:: Document.prototype.resolveLink(uri)
...
.. method:: Document.prototype.resolveLinkDestination(uri)
