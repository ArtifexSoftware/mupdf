...
static void
fz_trace_fill_image(fz_context *ctx, fz_device *dev, fz_image *image, const fz_matrix *ctm, float alpha, const fz_color_params *cs_params)
{
	fz_output *out = ((fz_trace_device*)dev)->out;
...
static void
fz_trace_fill_shade(fz_context *ctx, fz_device *dev, fz_shade *shade, const fz_matrix *ctm, float alpha, const fz_color_params *cs_params)
{
	fz_output *out = ((fz_trace_device*)dev)->out;
...
static void
fz_trace_begin_mask(fz_context *ctx, fz_device *dev, const fz_rect *bbox, int luminosity, fz_colorspace *colorspace, const float *color, const fz_color_params *cs_params)
{
	fz_output *out = ((fz_trace_device*)dev)->out;
