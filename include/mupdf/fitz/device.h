...
struct fz_device_s
{
	...
	void (*fill_shade)(fz_context *, fz_device *, fz_shade *shd, const fz_matrix *ctm, fz_color_params *cs_params, float alpha);
...
void fz_fill_shade(fz_context *ctx, fz_device *dev, fz_shade *shade, const fz_matrix *ctm, fz_color_params *cs_params, float alpha);
