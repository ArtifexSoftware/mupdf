...
*/
fz_pixmap *fz_convert_pixmap(fz_context *ctx, fz_pixmap *pix, fz_colorspace *cs_des, fz_colorspace *prf, fz_page_default_cs *default_cs, const fz_color_params *cs_params, int keep_alpha);
...
*/
typedef void (fz_pixmap_converter)(fz_context *ctx, fz_pixmap *dp, fz_pixmap *sp, fz_colorspace *prf, fz_page_default_cs *default_cs, const fz_color_params *cs_params);
