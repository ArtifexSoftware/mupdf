...
Usage:
    ...
    Args:
        ...
        --sync [-d] <destination>
            ...
            into a remote location. Also uploads a small top-level generated
            index.html file containing links to the C, C++ and Python pages
            along with information on the date and git id for the generation.

            E.g. --sync -d julian@casper.ghostscript.com:~julian/public_html/mupdf-bindings/
...
classextras = ClassExtras(
        ...
        pdf_processor = ClassExtra(
                virtual_fnptrs = (
                    ...
                    f'm_internal = (pdf_processor*) {rename.function_call("pdf_new_processor")}(sizeof(*m_internal) + sizeof(PdfProcessor2*));\n'
...
def function_wrapper_class_aware(
    ...
    for arg in get_args( tu, fn_cursor):
        ...
        if arg.alt:
            ...
            if (1
                    ...
                    and rename.class_(clip( arg.alt.type.spelling, 'struct ')) == class_name
    ...
    if warning_not_copyable:
        log( '*** warning: {struct_name=} {g_show_details(struct_name)=} {class_name}::{decl_h}:'
    ...
    if warning_no_raw_constructor:
        log( '*** warning: {struct_name=} {class_name}::{decl_h}:'
                ' Not able to return wrapper class {return_type}'
                ' for {return_cursor.spelling}'
                ...
                if sync_docs:
                    ...
                    with open( top_index_html, 'w') as f:
                        ...
                        f.write( textwrap.dedent( f'''
                                ...
                                <ul>
                                    <li><a href="mupdf/include/html/index.html">C</a> (generated by Doxygen).
                                    <li><a href="mupdf/platform/c++/include/html/index.html">C++</a> (generated by Doxygen).
                                    <li><a href="mupdf/build/shared-release/mupdf.html">Python</a> (generated by Pydoc).
                                </ul>
                                <small>
                                <small>
                                <p>Generation:
