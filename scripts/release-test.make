...
test-examples: make-examples pdfref17.pdf
	...
	/usr/bin/test f7c1e9d376b472f3f87dfda30a6b7af5 == $$(./build/release/pdf-version-select docs/examples/multi-version.pdf 2>&1 | md5sum - | cut -d' ' -f1)
	/usr/bin/test a62c0d40e26cc70a933f76249df21512 == $$(./build/release/mutool run docs/examples/pdf-version-select.js docs/examples/multi-version.pdf 2>&1 | md5sum - | cut -d' ' -f1)
